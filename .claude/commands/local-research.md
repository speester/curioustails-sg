...
## VARIABLES — read from `project-config.md` first
...
Also read `business-context.md` for: what they sell, audience, differentiation,
...
2. Confirm `batch_web_search` and `crawler` are available.
...
- Run `batch_web_search` to get the live organic set.
