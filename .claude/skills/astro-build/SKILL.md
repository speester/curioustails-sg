...
description: >
  ...
  "scaffold Astro", or starts Stage 2. Reads design-system.md, business-context.md,
...
## VARIABLES (from `project-config.md`)
REQUIRED:
...
- `business-context.md`                       (real facts, voice, proof)
...
Fill with realistic placeholder copy drawn from business-context.md (clearly
...
- [ ] **Every built page passes the PAGE-BUILD BUG CHECKLIST** in
      RUN-THE-PROJECT.md (no links to unbuilt routes; every
      ...
      vaccination/licensing facts exact per business-context.md; stacked
