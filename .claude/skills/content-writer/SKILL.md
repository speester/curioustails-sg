...
expertise-library.md (real stories/numbers/quotes — the E-E-A-T source),
business-context.md (voice + the CANONICAL Singapore Regulatory & Health Facts
...
- Respect consent flags in expertise-library.md: named testimonials/case studies
...
Read the brief + expertise-library.md + business-context.md. Produce a one-page
...
expertise-library.md it will use — cite the line. Do not write prose yet.
...
Trace every factual claim to the brief or expertise-library.md. Mark any
...
full rationale is **RUN-THE-PROJECT.md → "PAGE-BUILD BUG CHECKLIST"** — read it.
...
4. **Singapore health/licensing facts are exact** — vaccinations weeks 6/8/12 (not 6/9/12),
   ...
   block in business-context.md. This is where the page can silently ship wrong facts.
...
manufacture E-E-A-T that isn't in expertise-library.md — that's why Pass 1 gates
