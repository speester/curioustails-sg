...
description: >
  ...
  E-E-A-T), then writes business-context.md AND expertise-library.md, and helps
  populate project-config.md. Use at the very start of a project, or when the
...
## Variables
None required to start. If project-config.md already has values (BUSINESS_NAME,
DOMAIN, etc.), read them and skip those questions.
WRITES: business-context.md, expertise-library.md, and offers to fill config.
...
## Founder / Personal Story (headline)   <short; depth is in expertise-library.md>
...
Offer to populate project-config.md fields you now know (BUSINESS_NAME,
