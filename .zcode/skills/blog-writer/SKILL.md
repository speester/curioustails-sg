...
Reads: config/business-context.md (voice + the CANONICAL Singapore Regulatory & Health
...
6/8/12 not 6/9/12), config/expertise-library.md (real experience),
...
## STEP 1 — Setup
- Voice: read config/business-context.md (and, if needed, fetch 1–2 live site pages).
  Every sentence must sound like the brand.
- Internal-link pool: read site-blueprint.csv and existing published pages.
...
where config/expertise-library.md content fits. Wait for approval before writing.
...
- Experience: pull real stories/numbers from config/expertise-library.md as first-
