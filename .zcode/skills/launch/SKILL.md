...
6. Contextual internal links (not footer dump)   16. llms.txt at root (REQUIRED)
...
Plus link architecture: every page reachable ≤3 clicks from home; zero orphan
pages (every page has ≥1 contextual inbound link beyond nav/footer).
Plus redirect discipline: any URL that changed since last deploy has a 301 in
