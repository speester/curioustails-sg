...
export function localBusinessSchema() {
  return {
    ...
    description: 'AVS-licensed puppy shop in Singapore offering Cavapoo, Maltipoo, Maltese, Mini Dachshund, Corgi, Shiba Inu, Bichonpoo, Bichon Frise, Cavapoochon, Chihuahua, and Cockapoo puppies with starter kit, free delivery *For Selected Puppies Only*, and training lessons included.',
    address: {
      '@type': 'PostalAddress',
